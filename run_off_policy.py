...
parser.add_argument('--mu', type=float, default=0.001, help='Lyapunov regularization parameter')
parser.add_argument('--modelType', type=str, default="lsac", help='Model type: sac or lsac')
