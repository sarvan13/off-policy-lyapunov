...
if __name__ == "__main__":
    ...
    data_path = os.path.join(curr_dir, "data", args.env_id, "clean_ly", "seed_" + str(args.seed))
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                mb_advantages = (1 - args.lyapunov_weight) * b_advantages[mb_inds] + args.lyapunov_weight * torch.min(torch.tensor(0), -(lyapunov.forward(b_next_obs[mb_inds]) - lyapunov.forward(b_obs[mb_inds])) / dt )
                if args.norm_adv:
