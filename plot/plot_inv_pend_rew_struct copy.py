...
for i in range(1, 11):
    rew.append(np.load(os.path.join(curr_dir, "data", "struct", "InvertedDoublePendulum-v5", "beta_0.5", "mu_0.001", "seed_" + str(i+10), "reward_arr.npy")))
    episode_steps= np.load(os.path.join(curr_dir, "data", "struct", "InvertedDoublePendulum-v5", "beta_0.5", "mu_0.001", "seed_" + str(i+10), "step_arr.npy"))
...
plt.xlabel("Steps")
plt.ylabel("Reward")
plt.title("Inverted Double Pendulum Structural Changes NN")
plt.legend()
plt.grid(True)
